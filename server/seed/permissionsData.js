const PERMISSIONS_CATALOG = [
  ...
  { key: 'sales.approve', module: 'VENDAS', label: 'Aprovar Vendas', description: 'Aprovar, concluir e cancelar vendas', sort_order: 42 },
  { key: 'sales.apply_discount', module: 'VENDAS', label: 'Aplicar Desconto', description: 'Aplicar descontos em vendas', sort_order: 43 },
  { key: 'sales.override_discount_limit', module: 'VENDAS', label: 'Ultrapassar Limite Desconto', description: 'Aplicar descontos além do limite padrão', sort_order: 44 },
  { key: 'sales.refund_or_cancel', module: 'VENDAS', label: 'Reembolsar/Cancelar', description: 'Cancelar ou reembolsar vendas', sort_order: 45 },
  ...
  { key: 'os.approve', module: 'ORDEM_SERVICO', label: 'Aprovar OS', description: 'Aprovar ordens de serviço', sort_order: 52 },
  { key: 'os.close', module: 'ORDEM_SERVICO', label: 'Fechar OS', description: 'Encerrar ordens de serviço', sort_order: 53 },
...
const LEGACY_PROFILE_MAPPING = {
  'GESTOR_FRANQUIA': [
    ...
    'sales.view', 'sales.manage', 'sales.approve', 'sales.apply_discount',
    'os.view', 'os.manage', 'os.approve', 'os.close',
